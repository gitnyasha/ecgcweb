                    ...
                    <div className="col-lg-6 col-sm-6">
                        <div className="single-service">
                            ...
                            <div className="service-content">
                                ...
                                <ReadMore description={'The Domestic Insurance Policy (DPIP) is designed to provide protection to Companies against commercial credit risks inherent in local transactions.'}/>
